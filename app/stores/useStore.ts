...
export const useAnalysisStore = create<AnalysisStore>((set) => ({
  ...
  applyYearCount: true,
  selectedYearCount: 5,
  applyMinimumPERatio: true,
  minimumPERatio: 0,
  applyMinimumGrowthOfGrowth: true,
  minimumGrowthOfGrowth: 5,
  ...
  setApplyMinimumPERatio: (applyMinimumPERatio) => set({ applyMinimumPERatio }),
  setMinimumPERatio: (peRatio) => set({ minimumPERatio: peRatio }),
  setApplyMinimumGrowthOfGrowth: (applyMinimumGrowthOfGrowth) => set({ applyMinimumGrowthOfGrowth }),
  setMinimumGrowthOfGrowth: (growth) => set({ minimumGrowthOfGrowth: growth }),
